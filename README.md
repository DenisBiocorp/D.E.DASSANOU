![From clinical biology to computational genomics: I ask the same questions, with new tools. Data quality is my first commitment](/image/illustration.png)

**`Master's student in Genomics and Bioinformatics | Clinical Biologist | Genomic Data Analyst`**

> *"From clinical biology to computational genomics: I ask the same questions, with new tools. Data quality is my first commitment."*
...
| Domain | Tools / Skills |
|--------|----------------|
| **NGS (preprocessing)** | FASTQC, MultiQC, Trimmomatic, Fastp, kmergenie, jellyfish |
| **Genome assembly** | Spades |
| **Genomic analysis** | PLINK (variant analysis) |
| **Scientific programming** | R (analysis & visualization), python (basics)|
| **Databases** | NCBI (SRA, dbSNP, BLAST ...), Ensembl, OMIM, UCSC, ... |
| **Environment** | Linux / command line |
| **Other software** | chromas, MethylPrimer, IGV, PyMOL |
| **Structural & Modeling** | FoldX (mutation analysis), AlphaFold 3 (AI-based structural prediction), Swiss Model (homology modeling) |
...
|--------|----------|-------------|
| 08/2024 – 10/2024 | **Senior Laboratory Technician & Quality Manager** | CMS Bè Kpota |
| 01/2024 – 08/2024 | **Senior Laboratory Technician & Biosecurity Manager** | CMS Bè Kpota |
| 11/2022 – 01/2024 | **National Volunteer – Senior Laboratory Technician** | CMS Bè Kpota (ANVT) |
| 09/2022 - 02/2023 | **Volunteer as part of the academic support project** | ADSIS Togo - Marianistes du Togo |
| 07/2022 – 11/2022 | **Intern – Laboratory Technician** | CHU Campus |
| 01/2022 – 06/2022 | **Intern – Laboratory Technician** | CMS ALPHA OMEGA |
...
| **6th International Photo Contest**| 20.03.2025-28.04.2025 | Photo + resume | МЫ УЧИМСЯ В РОССИИ |  
  ...
  [Certificate available upon request](https://drive.google.com/drive/folders/1a2AiZ138iyFXiNR16voJsPeJqxbLRuSS?usp=sharing)
...
Rigorous, dynamic, collaborative, creative, curious, enthusiastic

---


## 📧 **Email**: denisdassanou@gmail.com
